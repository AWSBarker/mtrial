...
# from /media/Data2/ve_django4/lib/python3.9/site-packages/pandas/_libs/arrays.cpython-39-x86_64-linux-gnu.so
# by generator 1.147
...
class NDArrayBacked(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fc5b6f31840>'


# variables with complex values

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc5b6f31ee0>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.arrays', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc5b6f31ee0>, origin='/media/Data2/ve39_sharepoint/lib/python3.9/site-packages/pandas/_libs/arrays.cpython-39-x86_64-linux-gnu.so')"
