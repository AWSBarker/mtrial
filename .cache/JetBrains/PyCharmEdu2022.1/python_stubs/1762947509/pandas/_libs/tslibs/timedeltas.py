...
# from /media/Data2/ve_django4/lib/python3.9/site-packages/pandas/_libs/tslibs/timedeltas.cpython-39-x86_64-linux-gnu.so
# by generator 1.147
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import collections as collections # /usr/lib/python3.9/collections/__init__.py
...
class _Timedelta(__datetime.timedelta):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7fc5b78b34b0>'
...
class Timedelta(_Timedelta):
    ...
    _req_any_kwargs_new = None # (!) real value is "{'seconds', 'minutes', 'weeks', 'milliseconds', 'microseconds', 'hours', 'nanoseconds', 'days'}"
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'pandas._libs.tslibs.timedeltas\', \'__doc__\': \'\\n    Represents a duration, the difference between two dates or times.\\n\\n    Timedelta is the pandas equivalent of python\\\'s ``datetime.timedelta``\\n    and is interchangeable with it in most cases.\\n\\n    Parameters\\n    ----------\\n    value : Timedelta, timedelta, np.timedelta64, str, or int\\n    unit : str, default \\\'ns\\\'\\n        Denote the unit of the input, if input is an integer.\\n\\n        Possible values:\\n\\n        * \\\'W\\\', \\\'D\\\', \\\'T\\\', \\\'S\\\', \\\'L\\\', \\\'U\\\', or \\\'N\\\'\\n        * \\\'days\\\' or \\\'day\\\'\\n        * \\\'hours\\\', \\\'hour\\\', \\\'hr\\\', or \\\'h\\\'\\n        * \\\'minutes\\\', \\\'minute\\\', \\\'min\\\', or \\\'m\\\'\\n        * \\\'seconds\\\', \\\'second\\\', or \\\'sec\\\'\\n        * \\\'milliseconds\\\', \\\'millisecond\\\', \\\'millis\\\', or \\\'milli\\\'\\n        * \\\'microseconds\\\', \\\'microsecond\\\', \\\'micros\\\', or \\\'micro\\\'\\n        * \\\'nanoseconds\\\', \\\'nanosecond\\\', \\\'nanos\\\', \\\'nano\\\', or \\\'ns\\\'.\\n\\n    **kwargs\\n        Available kwargs: {days, seconds, microseconds,\\n        milliseconds, minutes, hours, weeks}.\\n        Values for construction in compat with datetime.timedelta.\\n        Numpy ints and floats will be coerced to python ints and floats.\\n\\n    Notes\\n    -----\\n    The constructor may take in either both values of value and unit or\\n    kwargs as above. Either one of them must be used during initialization\\n\\n    The ``.value`` attribute is always in ns.\\n\\n    If the precision is higher than nanoseconds, the precision of the duration is\\n    truncated to nanoseconds.\\n\\n    Examples\\n    --------\\n    Here we initialize Timedelta object with both value and unit\\n\\n    >>> td = pd.Timedelta(1, "d")\\n    >>> td\\n    Timedelta(\\\'1 days 00:00:00\\\')\\n\\n    Here we initialize the Timedelta object with kwargs\\n\\n    >>> td2 = pd.Timedelta(days=1)\\n    >>> td2\\n    Timedelta(\\\'1 days 00:00:00\\\')\\n\\n    We see that either way we get the same result\\n    \', \'_req_any_kwargs_new\': {\'seconds\', \'minutes\', \'weeks\', \'milliseconds\', \'microseconds\', \'hours\', \'nanoseconds\', \'days\'}, \'__new__\': <cyfunction Timedelta.__new__ at 0x7fc5b788c790>, \'__setstate__\': <cyfunction Timedelta.__setstate__ at 0x7fc5b788c860>, \'__reduce__\': <cyfunction Timedelta.__reduce__ at 0x7fc5b788c930>, \'_round\': <cyfunction Timedelta._round at 0x7fc5b788ca00>, \'round\': <cyfunction Timedelta.round at 0x7fc5b788cad0>, \'floor\': <cyfunction Timedelta.floor at 0x7fc5b788cba0>, \'ceil\': <cyfunction Timedelta.ceil at 0x7fc5b788cc70>, \'__neg__\': <cyfunction _op_unary_method.<locals>.f at 0x7fc5b788ce10>, \'__pos__\': <cyfunction _op_unary_method.<locals>.f at 0x7fc5b7894040>, \'__abs__\': <cyfunction _op_unary_method.<locals>.f at 0x7fc5b78941e0>, \'__add__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7fc5b7894380>, \'__radd__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7fc5b7894520>, \'__sub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7fc5b78946c0>, \'__rsub__\': <cyfunction _binary_op_method_timedeltalike.<locals>.f at 0x7fc5b7894860>, \'__mul__\': <cyfunction Timedelta.__mul__ at 0x7fc5b7894930>, \'__rmul__\': <cyfunction Timedelta.__mul__ at 0x7fc5b7894930>, \'__truediv__\': <cyfunction Timedelta.__truediv__ at 0x7fc5b7894a00>, \'__rtruediv__\': <cyfunction Timedelta.__rtruediv__ at 0x7fc5b7894ad0>, \'__floordiv__\': <cyfunction Timedelta.__floordiv__ at 0x7fc5b7894ba0>, \'__rfloordiv__\': <cyfunction Timedelta.__rfloordiv__ at 0x7fc5b7894c70>, \'__mod__\': <cyfunction Timedelta.__mod__ at 0x7fc5b7894d40>, \'__rmod__\': <cyfunction Timedelta.__rmod__ at 0x7fc5b7894e10>, \'__divmod__\': <cyfunction Timedelta.__divmod__ at 0x7fc5b7894ee0>, \'__rdivmod__\': <cyfunction Timedelta.__rdivmod__ at 0x7fc5b7893040>, \'__dict__\': <attribute \'__dict__\' of \'Timedelta\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Timedelta\' objects>, \'min\': Timedelta(\'-106752 days +00:12:43.145224193\'), \'max\': Timedelta(\'106751 days 23:47:16.854775807\'), \'resolution\': Timedelta(\'0 days 00:00:00.000000001\')})'


# variables with complex values

_no_input = None # (!) real value is '<object object at 0x7fc5b876e620>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc5b78b3c10>'

__pyx_capi__ = {
    'convert_to_timedelta64': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *)" at 0x7fc5b78b3540>'
    'delta_to_nanoseconds': None, # (!) real value is '<capsule object "__pyx_t_5numpy_int64_t (PyObject *, int __pyx_skip_dispatch)" at 0x7fc5b78b3570>'
    'is_any_td_scalar': None, # (!) real value is '<capsule object "int (PyObject *)" at 0x7fc5b78b3510>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.timedeltas', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc5b78b3c10>, origin='/media/Data2/ve39_sharepoint/lib/python3.9/site-packages/pandas/_libs/tslibs/timedeltas.cpython-39-x86_64-linux-gnu.so')"

__test__ = {
    '_Timedelta.asm8.__get__ (line 985)': "\n        Return a numpy timedelta64 array scalar view.\n\n        Provides access to the array scalar view (i.e. a combination of the\n        value and the units) associated with the numpy.timedelta64().view(),\n        including a 64-bit integer representation of the timedelta in\n        nanoseconds (Python int compatible).\n\n        Returns\n        -------\n        numpy timedelta64 array scalar view\n            Array scalar view of the timedelta in nanoseconds.\n\n        Examples\n        --------\n        >>> td = pd.Timedelta('1 days 2 min 3 us 42 ns')\n        >>> td.asm8\n        numpy.timedelta64(86520000003042,'ns')\n\n        >>> td = pd.Timedelta('2 min 3 s')\n        >>> td.asm8\n        numpy.timedelta64(123000000000,'ns')\n\n        >>> td = pd.Timedelta('3 ms 5 us')\n        >>> td.asm8\n        numpy.timedelta64(3005000,'ns')\n\n        >>> td = pd.Timedelta(42, unit='ns')\n        >>> td.asm8\n        numpy.timedelta64(42,'ns')\n        ",
    '_Timedelta.delta.__get__ (line 955)': "\n        Return the timedelta in nanoseconds (ns), for internal compatibility.\n\n        Returns\n        -------\n        int\n            Timedelta in nanoseconds.\n\n        Examples\n        --------\n        >>> td = pd.Timedelta('1 days 42 ns')\n        >>> td.delta\n        86400000000042\n\n        >>> td = pd.Timedelta('3 s')\n        >>> td.delta\n        3000000000\n\n        >>> td = pd.Timedelta('3 ms 5 us')\n        >>> td.delta\n        3005000\n\n        >>> td = pd.Timedelta(42, unit='ns')\n        >>> td.delta\n        42\n        ",
    '_Timedelta.isoformat (line 1170)': "\n        Format Timedelta as ISO 8601 Duration like\n        ``P[n]Y[n]M[n]DT[n]H[n]M[n]S``, where the ``[n]`` s are replaced by the\n        values. See https://en.wikipedia.org/wiki/ISO_8601#Durations.\n\n        Returns\n        -------\n        str\n\n        See Also\n        --------\n        Timestamp.isoformat : Function is used to convert the given\n            Timestamp object into the ISO format.\n\n        Notes\n        -----\n        The longest component is days, whose value may be larger than\n        365.\n        Every component is always included, even if its value is 0.\n        Pandas uses nanosecond precision, so up to 9 decimal places may\n        be included in the seconds component.\n        Trailing 0's are removed from the seconds component after the decimal.\n        We do not 0 pad components, so it's `...T5H...`, not `...T05H...`\n\n        Examples\n        --------\n        >>> td = pd.Timedelta(days=6, minutes=50, seconds=3,\n        ...                   milliseconds=10, microseconds=10, nanoseconds=12)\n\n        >>> td.isoformat()\n        'P6DT0H50M3.010010012S'\n        >>> pd.Timedelta(hours=1, seconds=10).isoformat()\n        'P0DT1H0M10S'\n        >>> pd.Timedelta(days=500.5).isoformat()\n        'P500DT12H0M0S'\n        ",
    '_Timedelta.nanoseconds.__get__ (line 1078)': "\n        Return the number of nanoseconds (n), where 0 <= n < 1 microsecond.\n\n        Returns\n        -------\n        int\n            Number of nanoseconds.\n\n        See Also\n        --------\n        Timedelta.components : Return all attributes with assigned values\n            (i.e. days, hours, minutes, seconds, milliseconds, microseconds,\n            nanoseconds).\n\n        Examples\n        --------\n        **Using string input**\n\n        >>> td = pd.Timedelta('1 days 2 min 3 us 42 ns')\n\n        >>> td.nanoseconds\n        42\n\n        **Using integer input**\n\n        >>> td = pd.Timedelta(42, unit='ns')\n        >>> td.nanoseconds\n        42\n        ",
    '_Timedelta.resolution_string.__get__ (line 1020)': "\n        Return a string representing the lowest timedelta resolution.\n\n        Each timedelta has a defined resolution that represents the lowest OR\n        most granular level of precision. Each level of resolution is\n        represented by a short string as defined below:\n\n        Resolution:     Return value\n\n        * Days:         'D'\n        * Hours:        'H'\n        * Minutes:      'T'\n        * Seconds:      'S'\n        * Milliseconds: 'L'\n        * Microseconds: 'U'\n        * Nanoseconds:  'N'\n\n        Returns\n        -------\n        str\n            Timedelta resolution.\n\n        Examples\n        --------\n        >>> td = pd.Timedelta('1 days 2 min 3 us 42 ns')\n        >>> td.resolution_string\n        'N'\n\n        >>> td = pd.Timedelta('1 days 2 min 3 us')\n        >>> td.resolution_string\n        'U'\n\n        >>> td = pd.Timedelta('2 min 3 s')\n        >>> td.resolution_string\n        'S'\n\n        >>> td = pd.Timedelta(36, unit='us')\n        >>> td.resolution_string\n        'U'\n        ",
}
